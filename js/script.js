window.addEventListener('DOMContentLoaded', () => {
    ...
    /*const getResource = async (url)  => {
        ...
        if (!res.ok) {
            throw new Eror(`Could not fetch ${url}, status: ${res.status}`); 
        }
    ...
    const message = {
        ...
        success: 'Спсаибо! Скоро мы с вами свяжемся',
    ...
    fetch('http://localhost:3000/menu') //npx json-server --watch db.json*/
        .then(data => data.json())
